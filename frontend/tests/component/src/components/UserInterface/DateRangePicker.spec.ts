...
describe("DateRangePicker", () => {
  ...
  it("renders as expected when there are date filters set", () => {
    ...
    cy.findByDisplayValue("05/30/2022 12:00:00").should("be.visible");
  });
  it("correctly sets the 'start' date filter when a date is entered into the start input", () => {
    factory();
    cy.findAllByPlaceholderText("The beginning of time")
      .click()
      .type("05/25/2022 08:00:00", { force: true })
      .type("{enter}", { force: true });
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
      filterValue: new Date(Date.UTC(2022, 4, 25, 8, 0, 0, 0)),
      isIncluded: true,
    });
  });
  ...
  it("correctly sets the date filters when the 'Today' button is clicked", () => {
    ...
    cy.findByDisplayValue("03/29/2022 00:00:00").should("be.visible");
    cy.findByDisplayValue("03/29/2022 23:59:59").should("be.visible");
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
  ...
  it("correctly sets the date filters when the 'Yesterday' button is clicked", () => {
    ...
    cy.findByDisplayValue("03/28/2022 00:00:00").should("be.visible");
    cy.findByDisplayValue("03/28/2022 23:59:59").should("be.visible");
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
  ...
  it("correctly sets the date filters when the 'Last 7 Days' button is clicked", () => {
    ...
    cy.findByDisplayValue("03/22/2022 00:00:00").should("be.visible");
    cy.findByDisplayValue("03/29/2022 23:59:59").should("be.visible");
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
  ...
  it("correctly sets the date filters when the 'Last 30 Days' button is clicked", () => {
    ...
    cy.findByDisplayValue("02/27/2022 00:00:00").should("be.visible");
    cy.findByDisplayValue("03/29/2022 23:59:59").should("be.visible");
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
  ...
  it("correctly sets the date filters when the 'Last 60 Days' button is clicked", () => {
    ...
    cy.findByDisplayValue("01/28/2022 00:00:00").should("be.visible");
    cy.findByDisplayValue("03/29/2022 23:59:59").should("be.visible");
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
  ...
  it("correctly sets the date filters when the 'This Month' button is clicked", () => {
    ...
    cy.findByDisplayValue("03/01/2022 00:00:00").should("be.visible");
    cy.findByDisplayValue("03/29/2022 23:59:59").should("be.visible");
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
  ...
  it("correctly sets the date filters when the 'Last Month' button is clicked", () => {
    ...
    cy.findByDisplayValue("02/01/2022 00:00:00").should("be.visible");
    cy.findByDisplayValue("02/28/2022 23:59:59").should("be.visible");
    cy.get("@spy-2").should("be.calledWith", {
      objectType: "alerts",
      filterName: "eventTimeAfter",
  ...
  it("clears currently set date filters when date filter type is changed", () => {
    ...
    cy.findByDisplayValue("03/25/2022 12:00:00").should("be.visible");
    cy.findByDisplayValue("03/30/2022 12:00:00").should("be.visible");
  });
});
