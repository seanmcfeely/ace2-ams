...
const MOCK_ALERT_CREATE: alertCreate = { name: "Test", queue: "Default", type: "test", observableInstances: [] }
const MOCK_ALERT_UPDATE: alertUpdate = { version: "test" }
const MOCK_PARAMS: alertFilterParams = { limit: 10, offset: 10, name: "Test Name", observableTypes: ["testA", "testB"], tags: ["tagA", "tagB"], threats: ["threatA", "threatB"], observable: { category: "test", value: "example" } }
...
describe("Alert calls", () => {
    ...
    it("will make a get request to the /alert/ endpoint when 'readPage' is called properly formatted params", async () => {
        myNock
            .get("/alert/?limit=10&offset=10&name=Test+Name&observable_types=testA,testB&tags=tagA,tagB&threats=threatA,threatB&observable=test%7Cexample")
            .reply(200, "Read successful");
