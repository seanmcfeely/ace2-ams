...
describe("Comment API calls", () => {
  ...
  it("will make a get request to /event/comment/{uuid} when getSingle is called", async () => {
  ...
  it("will make a patch request to /event/comment/{uuid} when updateSingle is called", async () => {
    myNock
      .patch(
        "/event/comment/1",
