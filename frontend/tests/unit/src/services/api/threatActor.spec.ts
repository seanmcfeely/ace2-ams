...
describe("threatActor API calls", () => {
  ...
  it("will make a get request to /threat_actor/{uuid} when getSingle is called", async () => {
  ...
  it("will make a patch request to /threat_actor/{uuid} when updateSingle is called", async () => {
    myNock
