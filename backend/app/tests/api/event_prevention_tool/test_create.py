...
def test_create_valid_optional_fields(client_valid_token, key, value):
    # Create the object
    create = client_valid_token.post("/api/event/prevention_tool/", json={key: value, "value": "test"})
...
def test_create_valid_required_fields(client_valid_token):
    # Create the object
    create = client_valid_token.post("/api/event/prevention_tool/", json={"value": "test"})
    assert create.status_code == status.HTTP_201_CREATED
