...
def test_update_invalid_fields(client_valid_token, key, value):
    update = client_valid_token.patch(f"/api/alert/{uuid.uuid4()}", json={key: value, "version": str(uuid.uuid4())})
...
def test_update_invalid_node_fields(client_valid_token, key, value):
    update = client_valid_token.patch(f"/api/alert/{uuid.uuid4()}", json={"version": str(uuid.uuid4()), key: value})
    assert update.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
    assert key in update.text


def test_update_invalid_uuid(client_valid_token):
    update = client_valid_token.patch("/api/alert/1", json={"version": str(uuid.uuid4())})
    assert update.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
...
def test_update_invalid_version(client_valid_token):
    ...
    update = client_valid_token.patch(create.headers["Content-Location"], json={"version": str(uuid.uuid4())})
...
def test_update_nonexistent_fields(client_valid_token, key, value):
    ...
    update = client_valid_token.patch(create.headers["Content-Location"], json={key: value, "version": version})
...
def test_update_nonexistent_uuid(client_valid_token):
    update = client_valid_token.patch(f"/api/alert/{uuid.uuid4()}", json={"version": str(uuid.uuid4())})
    assert update.status_code == status.HTTP_404_NOT_FOUND
...
def test_update_disposition(client_valid_token):
    # Create an alert queue and type
    client_valid_token.post("/api/alert/queue/", json={"value": "test_queue"})
    client_valid_token.post("/api/alert/type/", json={"value": "test_type"})
    ...
    client_valid_token.post("/api/alert/disposition/", json={"rank": 1, "value": "test"})
...
def test_update_event_uuid(client_valid_token):
    # Create an alert queue and type
    client_valid_token.post("/api/alert/queue/", json={"value": "test_queue"})
    client_valid_token.post("/api/alert/type/", json={"value": "test_type"})
    ...
    event_create = client_valid_token.post(
        "/api/event/",
        json={
    ...
    get_event = client_valid_token.get(event_create.headers["Content-Location"])
...
def test_update_owner(client_valid_token):
    ...
    # Update the owner
    update = client_valid_token.patch(create.headers["Content-Location"], json={"owner": "johndoe", "version": version})
    assert update.status_code == status.HTTP_204_NO_CONTENT
...
def test_update_queue(client_valid_token):
    # Create an alert queue and type
    client_valid_token.post("/api/alert/queue/", json={"value": "test_queue"})
    client_valid_token.post("/api/alert/type/", json={"value": "test_type"})
    ...
    client_valid_token.post("/api/alert/queue/", json={"value": "test_queue2"})
...
def test_update_tool(client_valid_token):
    # Create an alert queue and type
    client_valid_token.post("/api/alert/queue/", json={"value": "test_queue"})
    client_valid_token.post("/api/alert/type/", json={"value": "test_type"})
    ...
    # Update the tool
    update = client_valid_token.patch(create.headers["Content-Location"], json={"tool": "test", "version": version})
    assert update.status_code == status.HTTP_204_NO_CONTENT
...
def test_update_tool_instance(client_valid_token):
    # Create an alert queue and type
    client_valid_token.post("/api/alert/queue/", json={"value": "test_queue"})
    client_valid_token.post("/api/alert/type/", json={"value": "test_type"})
    ...
    client_valid_token.post("/api/alert/tool/instance/", json={"value": "test"})
...
def test_update_type(client_valid_token):
    ...
    client_valid_token.post("/api/alert/type/", json={"value": "test_type2"})
...
def test_update_valid_node_tags(client_valid_token, values):
    ...
    # Update the node
    update = client_valid_token.patch(create.headers["Content-Location"], json={"tags": values, "version": version})
    assert update.status_code == status.HTTP_204_NO_CONTENT
...
def test_update_valid_node_threats(client_valid_token, values):
    ...
    # Update the node
    update = client_valid_token.patch(create.headers["Content-Location"], json={"threats": values, "version": version})
    assert update.status_code == status.HTTP_204_NO_CONTENT
