...
def test_create_duplicate_unique_fields(client_valid_token, key):
    ...
    client_valid_token.post("/api/analysis/module_type/", json=create1_json)

    # Ensure you cannot create another object with the same unique field value
    create2_json = {"value": "test2", "version": "1.0.0"}
    create2_json[key] = create1_json[key]
    create2 = client_valid_token.post("/api/analysis/module_type/", json=create2_json)
    assert create2.status_code == status.HTTP_409_CONFLICT


def test_create_duplicate_version_value(client_valid_token):
    # Create an object
...
def test_create_nonexistent_list_values(client_valid_token, key):
    create = client_valid_token.post("/api/analysis/module_type/", json={"value": "test", "version": "1.0.0", key: ["test_value"]})
...
def test_create_valid_optional_fields(client_valid_token, key, value):
    # Create the object
    create = client_valid_token.post("/api/analysis/module_type/", json={key: value, "value": "test", "version": "1.0.0"})
...
def test_create_valid_list_fields(client_valid_token, api_endpoint, key, values):
    ...
    create = client_valid_token.post("/api/analysis/module_type/", json={key: values, "value": "test", "version": "1.0.0"})
    assert create.status_code == status.HTTP_201_CREATED
