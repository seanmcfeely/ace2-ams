...
def test_create_invalid_fields(client_valid_token, key, value):
    create = client_valid_token.post("/api/analysis/", json={key: value})
...
def test_create_duplicate_unique_fields(client_valid_token, key):
    ...
    client_valid_token.post("/api/analysis/", json=create1_json)

    # Ensure you cannot create another object with the same unique field value
    create2_json = {}
    create2_json[key] = create1_json[key]
    create2 = client_valid_token.post("/api/analysis/", json=create2_json)
    assert create2.status_code == status.HTTP_409_CONFLICT


def test_create_nonexistent_analysis_module_type(client_valid_token):
    create = client_valid_token.post("/api/analysis/", json={"analysis_module_type": str(uuid.uuid4())})
    assert create.status_code == status.HTTP_404_NOT_FOUND


def test_create_nonexistent_parent_observable_uuid(client_valid_token):
    create = client_valid_token.post("/api/analysis/", json={"parent_observable_uuid": str(uuid.uuid4())})
    assert create.status_code == status.HTTP_404_NOT_FOUND
...
def test_create_valid_analysis_module_type(client_valid_token):
    # Create an analysis module type
    analysis_module_type_uuid = str(uuid.uuid4())
    client_valid_token.post(
    ...
    create = client_valid_token.post("/api/analysis/", json={"analysis_module_type": analysis_module_type_uuid})
    assert create.status_code == status.HTTP_201_CREATED
...
def test_create_valid_parent_observable_uuid(client_valid_token):
    # Create an alert
    ...
    observable_create = client_valid_token.post("/api/observable/instance/", json=create_json)
    assert observable_create.status_code == status.HTTP_201_CREATED

    # Read the observable instance back to get its current version
    get_observable = client_valid_token.get(observable_create.headers["Content-Location"])
    ...
    create = client_valid_token.post("/api/analysis/", json={
...
def test_create_valid_node_directives(client_valid_token, values):
    ...
    # Create the node
    create = client_valid_token.post("/api/analysis/", json={"directives": values})
    assert create.status_code == status.HTTP_201_CREATED
...
def test_create_valid_node_tags(client_valid_token, values):
    ...
    # Create the node
    create = client_valid_token.post("/api/analysis/", json={"tags": values})
    assert create.status_code == status.HTTP_201_CREATED
...
def test_create_valid_node_threat_actor(client_valid_token, value):
    ...
    # Create the node
    create = client_valid_token.post("/api/analysis/", json={"threat_actor": value})
    assert create.status_code == status.HTTP_201_CREATED
...
def test_create_valid_node_threats(client_valid_token, values):
    ...
    # Create the node
    create = client_valid_token.post("/api/analysis/", json={"threats": values})
    assert create.status_code == status.HTTP_201_CREATED
