...
def test_create_invalid_node_fields(client_valid_token, key, value):
    create = client_valid_token.post("/api/event/", json={key: value, "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
...
def test_create_duplicate_unique_fields(client_valid_token, key):
    ...
    client_valid_token.post("/api/event/", json=create1_json)

    # Ensure you cannot create another object with the same unique field value
    create2_json = {"name": "test2", "status": "OPEN"}
    create2_json[key] = create1_json[key]
    create2 = client_valid_token.post("/api/event/", json=create2_json)
...
def test_create_nonexistent_owner(client_valid_token):
    ...
    # Create an object
    create = client_valid_token.post("/api/event/", json={"owner": "johndoe", "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_404_NOT_FOUND
    assert "user" in create.text


def test_create_nonexistent_prevention_tools(client_valid_token):
    # Create an event status
    client_valid_token.post("/api/event/status/", json={"value": "OPEN"})

    # Create an object
    create = client_valid_token.post("/api/event/", json={"prevention_tools": ["test"], "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_404_NOT_FOUND
    assert "event_prevention_tool" in create.text


def test_create_nonexistent_remediations(client_valid_token):
    # Create an event status
    client_valid_token.post("/api/event/status/", json={"value": "OPEN"})

    # Create an object
    create = client_valid_token.post("/api/event/", json={"remediations": ["test"], "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_404_NOT_FOUND
    assert "event_remediation" in create.text


def test_create_nonexistent_risk_level(client_valid_token):
    # Create an event status
    client_valid_token.post("/api/event/status/", json={"value": "OPEN"})

    # Create an object
    create = client_valid_token.post("/api/event/", json={"risk_level": "test", "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_404_NOT_FOUND
    assert "event_risk_level" in create.text


def test_create_nonexistent_source(client_valid_token):
    # Create an event status
    client_valid_token.post("/api/event/status/", json={"value": "OPEN"})

    # Create an object
    create = client_valid_token.post("/api/event/", json={"source": "test", "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_404_NOT_FOUND
    assert "event_source" in create.text


def test_create_nonexistent_status(client_valid_token):
    # Create an object
...
def test_create_nonexistent_type(client_valid_token):
    ...
    # Create an object
    create = client_valid_token.post("/api/event/", json={"type": "test", "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_404_NOT_FOUND
    assert "event_type" in create.text


def test_create_nonexistent_vectors(client_valid_token):
    # Create an event status
    client_valid_token.post("/api/event/status/", json={"value": "OPEN"})

    # Create an object
    create = client_valid_token.post("/api/event/", json={"vectors": ["test"], "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_404_NOT_FOUND
...
def test_create_valid_prevention_tools(client_valid_token):
...
def test_create_valid_remediations(client_valid_token):
...
def test_create_valid_risk_level(client_valid_token):
...
def test_create_valid_source(client_valid_token):
...
def test_create_valid_type(client_valid_token):
...
def test_create_valid_vectors(client_valid_token):
...
def test_create_valid_node_directives(client_valid_token, values):
    ...
    # Create the node
    create = client_valid_token.post("/api/event/", json={"directives": values, "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_201_CREATED
...
def test_create_valid_node_tags(client_valid_token, values):
    ...
    # Create the node
    create = client_valid_token.post("/api/event/", json={"tags": values, "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_201_CREATED
...
def test_create_valid_node_threat_actor(client_valid_token, value):
    ...
    # Create the node
    create = client_valid_token.post("/api/event/", json={"threat_actor": value, "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_201_CREATED
...
def test_create_valid_node_threats(client_valid_token, values):
    ...
    # Create the node
    create = client_valid_token.post("/api/event/", json={"threats": values, "name": "test", "status": "OPEN"})
    assert create.status_code == status.HTTP_201_CREATED
