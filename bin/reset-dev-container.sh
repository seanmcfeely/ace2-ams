...
DEFAULT_ANALYSIS_MODE_ALERT=default_alert
DEFAULT_ANALYSIS_MODE_DETECT=default_detect
DEFAULT_ANALYSIS_MODE_EVENT=default_event
DEFAULT_ANALYSIS_MODE_RESPONSE=default_response
SQL_ECHO=yes
EOF
fi
